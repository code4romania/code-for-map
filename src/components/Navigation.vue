        ...
        <button class="p-4 focus:bg-gray-200 focus:outline-none">
          ...
          >
            <!-- :d="
              ...
              " -->
            <path
              d="M10 8.6L2.9 1.5 1.5 2.9 8.6 10l-7.1 7.1 1.4 1.4 7.1-7.1 7.1 7.1 1.4-1.4-7.1-7.1 7.1-7.1-1.4-1.4L10 8.6z"
            />
          </svg>
        </button>
      </div>
      ...
      >
        <li class="relative py-2 lg:ml-6">
          ...
          <div>
            ...
            <div
              class="pl-5 lg:shadow-xs lg:pl-0 lg:absolute lg:right-0 lg:mt-2 lg:w-48 lg:origin-top-right lg:bg-white lg:hidden"
            >
        ...
        <li class="relative py-2 lg:ml-6">
          <a
            ...
            class="relative inline-block w-full px-6 py-2 font-semibold leading-snug tracking-wide text-center shadow-md sm:w-auto hover:shadow-lg focus:outline-none focus:shadow-md text-white bg-green-400 focus:bg-green-500"
          >
            Donează
          </a>
        </li>

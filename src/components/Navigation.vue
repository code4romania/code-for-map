<template>
  <nav class="lg:shadow-none bg-white">
    <div
      class="container mx-auto flex flex-wrap items-center justify-between py-5 px-4"
    >
      <a href="https://code4.ro/" class="inline-block">
        <svg class="fill-current block h-10 w-auto" viewBox="0 0 400 121.9">
          <path
            ...
            fill="#00f"
          />
          <path d="M48.8,2.5,70.9,0V61H15.2Z" fill="#f2f2ff" />
          <path d="M48.8,119.4l22.1,2.5V61H15.2Z" fill="#d9d9ff" />
          <path d="M93,119.4l-22.1,2.5V61h55.7Z" fill="#b3b3ff" />
          <path d="M93,2.5,70.9,0V61h55.7Z" fill="#e6e6ff" />
          <path
        ...
        <li class="relative py-2 lg:ml-6">
          ...
          <div>
            ...
            >
              ...
              <svg class="fill-current -mr-1 ml-1 h-5 w-5" viewBox="0 0 24 24">
